        ...
        <div class="container">
            ...
            <div id="navbarCollapse" class="collapse navbar-collapse">
                <ul class="navbar-nav ml-auto">
                    <li class="active nav-link"><a href="<?php echo url_for('index.php')?>">HOME</a></li>
                    ...
                    <li class="nav-link"><a href="<?php echo url_for('login.php')?>">LOGIN</a></li>
                </ul>
            </div>
        </div>
    </nav>
    <div class="container">
        <h1 class="text-bold">Welcome to CICT Profile</h1>
        <img src="<?php echo url_for('assets/img/logo.png')?>" alt="Responsive image"  class="img-fluid img-thumbnail" style="background: transparent; border: none;">
    </div>
</div>